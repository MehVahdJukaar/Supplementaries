...
public class RegistryHelper {
    ...
    public static void initDynamicRegistry() {
        BlockSetManager.addDynamicBlockRegistration(RegistryHelper::registerHangingSignBlocks, WoodType.class);
        BlockSetManager.addDynamicItemRegistration(RegistryHelper::registerHangingSignItems, WoodType.class);
        BlockSetManager.addDynamicItemRegistration(RegistryHelper::registerSignPostItems, WoodType.class);
    }
