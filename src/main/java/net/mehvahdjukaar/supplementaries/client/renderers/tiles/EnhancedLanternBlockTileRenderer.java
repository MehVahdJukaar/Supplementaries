...
public class EnhancedLanternBlockTileRenderer<T extends  EnhancedLanternBlockTile> extends BlockEntityRenderer<T> {
    protected final BlockRenderDispatcher blockRenderer;
    public EnhancedLanternBlockTileRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {
