...
public class TextUtil {
    ...
    public static void renderLine(TextHolder textHolder, int line, Font font, int maxSizeX, float yOffset, PoseStack poseStack, MultiBufferSource buffer,
                                  int combinedLight, Supplier<Boolean> isVeryNear) {
        renderLine(textHolder, line, font, maxSizeX, yOffset, poseStack, buffer, new RenderTextProperties(textHolder, combinedLight, isVeryNear));
    }

    public static void renderAllLines(TextHolder textHolder, int ySeparation, Font font, int maxSizeX, PoseStack poseStack, MultiBufferSource buffer,
                                      RenderTextProperties properties) {
        for (int i = 0; i < textHolder.size(); i++) {
            renderLine(textHolder, i, font, maxSizeX, ySeparation * i, poseStack, buffer, properties);
        }
    }

    public static void renderAllLines(TextHolder textHolder, int ySeparation, Font font, int maxSizeX, PoseStack poseStack, MultiBufferSource buffer,
                                      int combinedLight, Supplier<Boolean> isVeryNear) {
        renderAllLines(textHolder, ySeparation, font, maxSizeX, poseStack, buffer, new RenderTextProperties(textHolder, combinedLight, isVeryNear));
    }
