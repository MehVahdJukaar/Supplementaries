...
import net.mehvahdjukaar.supplementaries.entities.OrangeTraderEntity;
...
public class OrangeTraderEntityRenderer extends MobRenderer<OrangeTraderEntity, OrangeTraderModel<OrangeTraderEntity>> {
    ...
    public ResourceLocation getTextureLocation(OrangeTraderEntity entity) {
