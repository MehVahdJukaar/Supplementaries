...
public class FireflyJarItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public void renderByItem(ItemStack stack, ItemTransforms.TransformType transformType, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        VertexConsumer ivertexbuilder = bufferIn.getBuffer(RenderType.entityTranslucent(Textures.FIREFLY_TEXTURE));
