...
public abstract class StatueEntityRenderer extends EntityRenderer<AbstractClientPlayerEntity> implements IEntityRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
    ...
    public StatueEntityRenderer(EntityRendererManager rendererManager, boolean useSmallArms) {
