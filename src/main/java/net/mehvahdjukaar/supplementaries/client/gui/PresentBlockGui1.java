...
public class PresentBlockGui1 extends ContainerScreen<PresentContainer> implements IContainerListener {
    ...
    public static ScreenManager.IScreenFactory<PresentContainer, PresentBlockGui1> GUI_FACTORY =
            (container, inventory, title) -> {
                ...
                if (te instanceof PresentBlockTile) {
                    return new PresentBlockGui1(container, inventory, title, (PresentBlockTile) te);
                }
                return null;
            };

    public PresentBlockGui1(PresentContainer container, PlayerInventory inventory, ITextComponent text, PresentBlockTile tile) {
    ...
    public class PackButton extends AbstractButton {
        ...
        public void renderToolTip(MatrixStack matrixStack, int x, int y) {
            PresentBlockGui1.this.renderTooltip(matrixStack, DialogTexts.GUI_DONE, x, y);
        }

        @Override
        public void onPress() {
            PresentBlockGui1.this.setPacked();
    ...
    private class PresentTextFieldWidget extends TextFieldWidget {
        ...
        public boolean mouseClicked(double p_231044_1_, double p_231044_3_, int p_231044_5_) {
            if (this.active) {
                PresentBlockGui1.this.setFocused(this);
                PresentBlockGui1.this.sender.setFocus(false);
                PresentBlockGui1.this.recipient.setFocus(false);
