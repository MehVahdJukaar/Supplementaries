...
public class SlingshotParticle extends SpriteTexturedParticle {
    ...
    protected SlingshotParticle(ClientWorld world, double x, double y, double z, double xd, double yd, double zd) {
        super(world, x, y, z);
        this.xd = xd;
        this.yd = yd;
        this.zd = zd;
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            SlingshotParticle particle = new SlingshotParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
