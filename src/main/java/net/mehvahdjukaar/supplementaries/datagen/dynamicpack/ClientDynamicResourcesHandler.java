...
public class ClientDynamicResourcesHandler implements PreparableReloadListener {
    ...
    public static void afterClientInit(FMLConstructModEvent event) {
        DYNAMIC_TEXTURE_PACK.register(event);
    ...
    private void generateStaticResources(ResourceManager manager) {
        ...
        LOGGER.info("Generated runtime client resources in: {} seconds", (System.currentTimeMillis() - mills) / 1000f);
    }
