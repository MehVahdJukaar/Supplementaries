...
public class OrangeMerchantEntity extends AbstractVillagerEntity implements IRangedAttackMob {
    @Nullable
    ...
    public OrangeMerchantEntity(EntityType<? extends OrangeMerchantEntity> type, World world) {
        super(type, world);
        this.forcedLoading = true;
    }
    public OrangeMerchantEntity(World world) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new EquipAndRangeAttackGoal(this, 1.0D, 60,10, 20, 15, new ItemStack(Registry.BOMB_ITEM.get())));
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, MobEntity.class, 8, true, false, (mob) -> mob instanceof IMob && !(mob instanceof CreeperEntity)));
        ...
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, EvokerEntity.class, 10.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, VindicatorEntity.class, 8.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, VexEntity.class, 8.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, PillagerEntity.class, 13.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, IllusionerEntity.class, 12.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, ZoglinEntity.class, 8.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(1, new LookAtCustomerGoal(this));
        this.goalSelector.addGoal(2, new OrangeMerchantEntity.MoveToGoal(this, 2.0D, 0.35D));
    ...
    public void updateTrades() {
        ...
        this.addOffersFromItemListings(merchantoffers, OrangeMerchantTrades.TRADES, 5);
    }
    ...
    public void performRangedAttack(LivingEntity target, float power) {
        ...
        //bomb.xRot -= -90F;
        bomb.shoot(d0, d1 + (double)(f * 0.04F), d2, 1.25F, 0.9F);
    ...
    class MoveToGoal extends Goal {
        final OrangeMerchantEntity trader;
        final double stopDistance;
        final double speedModifier;

        MoveToGoal(OrangeMerchantEntity p_i50459_2_, double p_i50459_3_, double p_i50459_5_) {
        ...
        public void stop() {
            ...
            OrangeMerchantEntity.this.navigation.stop();
        }
        ...
        public void tick() {
            ...
            BlockPos blockpos = this.trader.getWanderTarget();
            if (blockpos != null && OrangeMerchantEntity.this.navigation.isDone()) {
                if (this.isTooFarAway(blockpos, 10.0D)) {
                    ...
                    OrangeMerchantEntity.this.navigation.moveTo(vector3d1.x, vector3d1.y, vector3d1.z, this.speedModifier);
                } else {
                    OrangeMerchantEntity.this.navigation.moveTo((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), this.speedModifier);
                }
            }
