...
public class ConfiguredPlugin extends ConfigScreen {
    ...
    static{
        ...
        addIcon("flag", Registry.FLAGS_ITEMS.get(DyeColor.GREEN).get());
    ...
    public static void openScreen(Minecraft mc){
        mc.setScreen(new ConfiguredPlugin(mc.screen));
    }
    ...
    public static void registerScreen(){
        ...
        container.registerExtensionPoint(ExtensionPoint.CONFIGGUIFACTORY,
                () -> (mc, screen) -> new ConfiguredPlugin(screen));

    }

    private ConfigScreen.ConfigList list = null;

    public ConfiguredPlugin(Screen parent) {
        super(parent, "\u00A76Supplementaries Configured", ClientConfigs.CLIENT_CONFIG, ServerConfigs.SERVER_CONFIG, Textures.EMPTY_TEXTURE);
    }

    public ConfiguredPlugin(Screen parent, String displayName, ForgeConfigSpec spec, UnmodifiableConfig values) {
                                ...
                                try {
                                    f.set(subMenu, new Button(10, 5, 44, 20,
                                            ...
                                            (onPress) -> {
                                                ...
                                                this.minecraft.setScreen(new ConfiguredPlugin(this, newTitle, ClientConfigs.CLIENT_CONFIG, (AbstractConfig) o));
                                            }));
                            ...
                            if (subMenu.getLabel().equals(label)) {
                                ...
                                try {
                                    f.set(subMenu, new Button(10, 5, 44, 20,
                                            ...
                                            (onPress) -> {
                                                String newTitle = "\u00A76Supplementaries" + " > " + label;
                                                this.minecraft.setScreen(new ConfiguredPlugin(this, newTitle, ServerConfigs.SERVER_CONFIG, (AbstractConfig) o));
                                            }));
                                } catch (IllegalAccessException ignored) {}
