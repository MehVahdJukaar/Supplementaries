...
public class Credits implements Serializable {
    ...
    //empty default one
    public static Credits INSTANCE = new Credits(new HashMap<>(), new ArrayList<>(), new ArrayList<>(),
    ...
    private static final class Supporter {
        ...
        private static final Codec<Supporter> CODEC = RecordCodecBuilder.create((i) -> i.group(
                        UUIDCodec.CODEC.optionalFieldOf("uuid").forGetter(p -> Optional.ofNullable(p.uuid)),
