...
public class BombExplosion extends Explosion {
    ...
    public BombExplosion(World world, @Nullable Entity entity, @Nullable DamageSource damageSource, @Nullable ExplosionContext context, double x, double y, double z, float radius, boolean fire, Mode interaction) {
        super(world, entity, damageSource, context, x, y, z, radius, fire, interaction);
        this.level = world;
        this.source = entity;
        this.radius = radius;
        this.x = x;
    ...
    private ExplosionContext makeDamageCalculator(@javax.annotation.Nullable Entity p_234894_1_) {
