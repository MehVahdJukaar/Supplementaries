...
public interface IBallisticBehavior extends IFireItemBehavior {
    ...
    // dont override this
    @Override
    default boolean fire(ItemStack stack, ServerLevel level, Vec3 firePos, Vec3 direction, float power, int inaccuracy, @Nullable Entity owner) {
    ...
    boolean fireInner(ItemStack stack, ServerLevel level, Vec3 firePos, Vec3 direction, float scaledPower,
                      int inaccuracy, @Nullable Entity owner);
