...
public class BeMoverHelper {
     ...
     */
    public static boolean handledByUs() {
        return CommonConfigs.Tweaks.PUSH_BLOCK_ENTITIES.get() && !handledByQuark();
    }

    /**
     * Whether Quark's module is present and enabled, and therefore owns piston moves.
     */
    public static boolean handledByQuark() {
