...
public class ModNetwork {
    ...
    private static void registerMessages(NetworkHelper.RegisterMessagesEvent event) {
        ...
        event.registerClientBound(ClientBoundLaunchCannonRiderPacket.CODEC);
        event.registerClientBound(ClientBoundPulleyAttemptPacket.CODEC);
        event.registerClientBound(ClientBoundPistonCooperatorsPacket.CODEC);
