...
public class SpawnMobBehavior implements IFireItemBehavior {
    ...
    private final Function<ItemStack, EntityType<?>> entityTypeSupplier;

    public SpawnMobBehavior(Function<ItemStack, EntityType<?>> entityTypeSupplier) {
        this.entityTypeSupplier = entityTypeSupplier;
    }

    public SpawnMobBehavior(EntityType<?> entityType) {
        this.entityTypeSupplier = (s) -> entityType;
    }
