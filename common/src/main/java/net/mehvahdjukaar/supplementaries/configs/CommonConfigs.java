...
public class CommonConfigs {
    ...
    private static void onRefresh() {
        ...
        if (xp.isEmpty()) xpBottlingOverride = EnchantingTableBlock.class::isInstance;
    ...
    public static class Functional {
        ...
        static {
            ...
            NAVAL_RAID_CHANCE = builder.comment("Chance for a raid wave to spawn in open water near the village instead of on land. Such waves arrive on boats steered by plunderers, which take the place of the wave pillagers. Set to 0 to disable")
    ...
    public static class Tools {
        ...
        public static final Supplier<Integer> BOMB_BLUE_SPLIT_COUNT;
        public static final Supplier<Double> BOMB_BLUE_BABY_RADIUS;
        public static final Supplier<Integer> BOMB_BLUE_BABY_FIRE;
