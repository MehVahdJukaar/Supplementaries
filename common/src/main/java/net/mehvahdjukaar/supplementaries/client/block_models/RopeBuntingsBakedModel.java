...
public class RopeBuntingsBakedModel implements CustomBakedModel {

    public RopeBuntingsBakedModel(ModelState transform, Function<Material, TextureAtlasSprite> spriteGetter) {
    }
