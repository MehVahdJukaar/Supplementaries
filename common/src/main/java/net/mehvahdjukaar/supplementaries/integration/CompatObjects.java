...
public class CompatObjects {
    ...
    public static final Supplier<Block> WALL_LANTERN = makeCompatObject("amendments:wall_lantern", BuiltInRegistries.BLOCK);
    public static final Supplier<Block> DIRECTIONAL_CAKE = makeCompatObject("amendments:directional_cake", BuiltInRegistries.BLOCK);
