...
public class ModTags {
    ...
    public static final TagKey<Block> IGNITED_BY_EXPLOSION = blockTag("ignited_by_explosion");
    ...
    public static final TagKey<Item> QUIVER_WHITELIST = itemTag("quiver_whitelist");
