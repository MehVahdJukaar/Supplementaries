package net.mehvahdjukaar.supplementaries.common.commands.platform;
...
import net.mehvahdjukaar.supplementaries.common.commands.arguments.platform.NoteBlockInstrumentArgument;
import net.mehvahdjukaar.supplementaries.common.commands.arguments.platform.SourceArgument;
...
public class RecordSongCommandImpl {
    ...
    public static int stop(CommandContext<CommandSourceStack> context, String name, int speedup) throws CommandSyntaxException {
        ...
        context.getSource().sendSuccess(() -> Component.translatable("commands.supplementaries.record.stop", savedName), false);
    ...
    public static int start(CommandContext<CommandSourceStack> context, NoteBlockInstrument... whitelist) throws CommandSyntaxException {
        ...
        context.getSource().sendSuccess(() -> Component.translatable("commands.supplementaries.record.start"), false);
